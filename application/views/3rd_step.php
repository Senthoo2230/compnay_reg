                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-shortcode">
                                    <div class='gf_browser_chrome gform_wrapper gravity-theme' id='gform_wrapper_5'>
                                        ...
                                        <form method='post' enctype='multipart/form-data' id='gform_5' action='<?php echo base_url(); ?>home/third_step'>
                                            <div class='gform_body gform-body'>
                                                <div id='gform_page_5_1' class='gform_page'>
                                                    <div class='gform_page_fields'>
                                                        <div id='gform_fields_5' class='gform_fields top_label form_sublabel_below description_below'>
                                                            <div id="field_5_68" class="gfield gfield--width-full gfield_html gfield_html_formatted gfield_no_follows_desc field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_68">
                                                                <h2>Company Details</h2>
                                                            </div>
                                                            <div id="field_5_76" class="gfield gfield--width-full field_sublabel_below field_description_below gfield_visibility_hidden" data-js-reload="field_5_76">
                                                                <div class='admin-hidden-markup'><i class='gform-icon gform-icon--hidden'></i><span>Hidden</span></div><label class='gfield_label' for='input_5_76'>Email</label>
                                                                <div class='ginput_container ginput_container_email'>
                                                                    <input name='input_76' id='input_5_76' type='text' value='' class='large' aria-invalid="false" />
                                                                </div>
                                                            </div>
                                                            <div id="field_5_11" class="gfield gfield--width-full field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_11"><label class='gfield_label screen-reader-text' for='input_5_11'>Company Name</label>
                                                                <div class='ginput_container ginput_container_text'>
                                                                    <input name='company_name' id='input_5_11' type='text' value='<?php echo set_value('company_name'); ?>' class='large' placeholder='Company Name' aria-invalid="false" />
                                                                    <div style="margin-top: 5px; font-size:14px; color:var(--wp--preset--color--vivid-red);">
                                                                        <?php echo form_error('company_name'); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div id="field_5_12" class="gfield gfield--width-half field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_12"><label class='gfield_label screen-reader-text' for='input_5_12'>Email</label>
                                                                <div class='ginput_container ginput_container_text'>
                                                                    <input name='email' id='input_5_12' type='text' value='<?php echo set_value('email'); ?>' class='large' placeholder='Email' aria-invalid="false" />
                                                                </div>
                                                                <div style="margin-top: 5px; font-size:14px; color:var(--wp--preset--color--vivid-red);">
                                                                    <?php echo form_error('email'); ?>
                                                                </div>
                                                            </div>
                                                            <div id="field_5_13" class="gfield gfield--width-half field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_13"><label class='gfield_label screen-reader-text' for='input_5_13'>Phone Number</label>
                                                                <div class='ginput_container ginput_container_text'>
                                                                    <input name='phone' id='input_5_13' type='text' value='<?php echo set_value('phone'); ?>' class='large' placeholder='Phone Number' aria-invalid="false" />
                                                                </div>
                                                                <div style="margin-top: 5px; font-size:14px; color:var(--wp--preset--color--vivid-red);">
                                                                    <?php echo form_error('phone'); ?>
                                                                </div>
                                                            </div>
                                                            <div id="field_5_14" class="gfield gfield--width-full field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_14"><label class='gfield_label screen-reader-text' for='input_5_14'>Business activity company will intake</label>
                                                                <div class='ginput_container ginput_container_textarea'>
                                                                    <textarea name='description' id='input_5_14' value='<?php echo set_value('description'); ?>' class='textarea small' placeholder='Business activity company will intake' aria-invalid="false" rows='10' cols='50'></textarea>
                                                                </div>
                                                                <div style="margin-top: 5px; font-size:14px; color:var(--wp--preset--color--vivid-red);">
                                                    ...
                                                    <div class='gform_page_footer top_label'>
                                                        <input type='button' id='gform_next_button_5_15' class='gform_next_button button' value='Next' onclick='jQuery("#gform_target_page_number_5").val("2");  jQuery("#gform_5").trigger("submit",[true]); ' onkeypress='if( event.keyCode == 13 ){ jQuery("#gform_target_page_number_5").val("2");  jQuery("#gform_5").trigger("submit",[true]); } ' />
                                                    </div>
                                                </div>
                                                <div id='gform_page_5_2' class='gform_page' style='display:none;'>
                                                    <div class='gform_page_fields'>
                                                        <div id='gform_fields_5_2' class='gform_fields top_label form_sublabel_below description_below'>
                                                            ...
                                                            <div id="field_5_16" class="gfield gfield--width-half field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_16"><label class='gfield_label screen-reader-text' for='input_5_16'>Address Line 1</label>
                                                                <div class='ginput_container ginput_container_text'><input name='input_16' id='input_5_16' type='text' value='' class='large' placeholder='Address Line 1' aria-invalid="false" /> </div>
                                                            </div>
                                                            <div id="field_5_18" class="gfield gfield--width-half field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_18"><label class='gfield_label screen-reader-text' for='input_5_18'>Address Line 2</label>
                                                                <div class='ginput_container ginput_container_text'><input name='input_18' id='input_5_18' type='text' value='' class='large' placeholder='Address Line 2' aria-invalid="false" /> </div>
                                                            </div>
                                                            <div id="field_5_19" class="gfield gfield--width-third field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_19"><label class='gfield_label screen-reader-text' for='input_5_19'>District</label>
                                                                <div class='ginput_container ginput_container_select'><select name='input_19' id='input_5_19' class='large gfield_select' aria-invalid="false">
                                                            ...
                                                            <div id="field_5_20" class="gfield gfield--width-third field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_20"><label class='gfield_label screen-reader-text' for='input_5_20'>City</label>
                                                                <div class='ginput_container ginput_container_select'><select name='input_20' id='input_5_20' class='large gfield_select' aria-invalid="false">
                                                            ...
                                                            <div id="field_5_21" class="gfield gfield--width-third field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_21"><label class='gfield_label screen-reader-text' for='input_5_21'>Postal Code</label>
                                                                <div class='ginput_container ginput_container_select'><select name='input_21' id='input_5_21' class='large gfield_select' aria-invalid="false">
                                                            ...
                                                            <div id="field_5_23" class="gfield gfield--width-half field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_5_23"><label class='gfield_label screen-reader-text' for='input_5_23'>GN Division</label>
                                                                <div class='ginput_container ginput_container_select'><select name='input_23' id='input_5_23' class='large gfield_select' aria-invalid="false">
                                                    ...
                                                    <div class='gform_page_footer top_label'><input type='submit' id='gform_previous_button_5' class='gform_previous_button button' value='Previous' onclick='if(window["gf_submitting_5"]){return false;}  window["gf_submitting_5"]=true;  ' onkeypress='if( event.keyCode == 13 ){ if(window["gf_submitting_5"]){return false;} window["gf_submitting_5"]=true;  jQuery("#gform_5").trigger("submit",[true]); }' /> <input type='submit' id='gform_submit_button_5' class='gform_button button' value='Next' onclick='if(window["gf_submitting_5"]){return false;}  window["gf_submitting_5"]=true;  ' onkeypress='if( event.keyCode == 13 ){ if(window["gf_submitting_5"]){return false;} window["gf_submitting_5"]=true;  jQuery("#gform_5").trigger("submit",[true]); }' />
                                                        <input type='hidden' class='gform_hidden' name='is_submit_5' value='1' />
                                                        <input type='hidden' class='gform_hidden' name='gform_submit' value='5' />

                                                        <input type='hidden' class='gform_hidden' name='gform_unique_id' value='' />
                                                        <input type='hidden' class='gform_hidden' name='state_5' value='WyJbXSIsImEwZGMzNWE3NjA3NTVhNTY2OWEwMzdiMjdlMTM5ODQ3Il0=' />
